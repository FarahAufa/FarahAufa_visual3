...
if e_1.Text='' then
  ...
  if Form5.zqry1.Locate('id_karyawan',e_1.Text,[]) then
  begin
 ...
 zqry1.SQL.Clear;
zqry1.SQL.Add('insert into karyawan values("'+e_1.Text+'","'+e_2.Text+'","'+e_3.Text+'","'+e_4.Text+'","'+e_5.Text+'","'+e_6.Text+'")');
 zqry1.ExecSQL ;
...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update karyawan set nm_karyawan= "'+e_1.Text+'",alamat="'+e_2.Text+'",no_telp="'+e_3.Text+'",email="'+e_4.Text+'",gaji="'+e_5.Text+'" where id_karyawan="'+id+'"');
zqry1. ExecSQL;
...
begin
zqry1.SQL.Clear;
zqry1.SQL.Add(' delete from karyawan where id_karyawan="'+id+'"');
zqry1. ExecSQL;
zqry1.SQL.Clear;
zqry1.SQL.Add('select * from karyawan');
zqry1.Open;
