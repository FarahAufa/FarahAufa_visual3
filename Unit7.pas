...
uses
  ...
  ZDataset, StdCtrls, Grids, DBGrids, ZAbstractConnection, ZConnection;
...
if e_1.Text='' then
 ...
 zqry1.SQL.Clear;
zqry1.SQL.Add('insert into table_user values("'+e_1.Text+'","'+e_2.Text+'","'+e_3.Text+'","'+e_4.Text+'")');
 zqry1.ExecSQL ;
...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update table_user set username= "'+e_1.Text+'",password="'+e_2.Text+'",level="'+e_3.Text+'" where id="'+id+'"');
zqry1. ExecSQL;
